 ...
 */
export function generateCookingTime(ingredientCount: number, recipeId?: number): number {
 ...
 */
export function generateServings(ingredientCount: number, recipeId?: number): number {
